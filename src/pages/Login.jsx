        ...
        <div className="min-h-screen flex items-center justify-center px-4"
            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <p className="text-xs font-sora tracking-[0.25em] uppercase mb-2"
                        style={{ color: "#94A3B8" }}>
                        Running Shoe Rental
                    </p>
                ...
                <div className="rounded-2xl p-8"
                    ...
                    {error && (
                        <div className="mb-5 rounded-xl px-4 py-3 text-sm font-sora"
                    ...
                    <form className="space-y-4" onSubmit={handleLogin} noValidate>
                        <div>
                            <label className="block text-xs font-sora mb-1.5" style={{ color: "#64748B" }}>
                                Email Address
                            </label>
                            <input
                                type="email"
