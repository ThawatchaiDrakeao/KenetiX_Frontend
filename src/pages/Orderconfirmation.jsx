        ...
        <div className="min-h-screen bg-[#0a0a0a] text-white px-6 py-12">
            <div className="max-w-lg mx-auto">
                ...
                <div className="text-center mb-8">
                    <div className="w-16 h-16 bg-[#1db559]/20 border border-[#1db559]/40 rounded-full flex items-center justify-center mx-auto mb-4">
                        <span className="text-[#C3FF51] text-2xl">✓</span>
                    </div>
                    <h1 className="text-2xl font-bold mb-1">Order Confirmed!</h1>
                    {orderDate && (
                        <p className="text-gray-500 text-xs mt-1">{orderDate}</p>
                    )}
                    <p className="text-gray-400 text-xs mt-2">Order ID</p>
                    <p className="text-gray-500 text-xs font-mono">{orderId}</p>
                </div>
                ...
                <p className="text-center text-gray-500 text-xs mb-6">
                    Deposit will be refunded within 3–5 business days after return.
                </p>
                <button
